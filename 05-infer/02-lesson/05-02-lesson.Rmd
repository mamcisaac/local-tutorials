...
pacman::p_load(openintro, skimr, GGally, infer, tidyverse, statsr, broom, learnr, cachem, gapminder, usdata, knitr, gridExtra, png, gtable, stringr, grid, kableExtra, gt, cowplot, patchwork, ggridges, Lahman, NHANES, janitor)
...
```{r tut0502ex7, exercise=TRUE, exercise.setup="testing_a_claim_setup"}
null <- gss2016 %>%
  na.omit %>% 
  specify(response = postlife, success = "YES") %>%
  hypothesize(null = "point", p = 0.75) %>%
