...
pacman::p_load(openintro, skimr, GGally, infer, tidyverse, statsr, broom, learnr, cachem, usdata, knitr, gridExtra, png, gtable, stringr, grid, kableExtra, gt, cowplot, patchwork, ggridges)
pacman::p_load_gh("hadley/emo", "monicathieu/learnrhash", "jennybc/gapminder")
